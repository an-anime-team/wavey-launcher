...
tos-violation-warning-message =
    Esse launcher é uma ferramenta não oficial, de nenhuma forma relacionada à {company-name}.
    ...
    Se está usando esse launcher, sua conta de jogador pode ser identificada como desconforme pela {company-name}.
