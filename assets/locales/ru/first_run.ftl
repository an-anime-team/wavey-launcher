...
welcome-page-message =
    Приветствую! Добро пожаловать в Wavey Launcher
...
tos-violation-warning-message =
    Этот лаунчер является неофициальным и ни в коем случае не относится к {company-name}.
    ...
    Если вы используете данный лаунчер - ваш игровой аккаунт может быть признан как нарушающий пользовательское соглашение {company-name}.

    Если это произойдёт - поскольку ваша учетная запись будет нарушать правила, {company-name} будут свободы делать то, что захотят, включая блокировку вашего аккаунта.
